...
function PredictionCard() {
  return (
    <div className="flex flex-col justify-center py-4 items-center bg-gray-800 w-full lg:w-1/2 m-auto">
      <div className="flex items-center justify-between py-2">
        <div className="flex items-center justify-center">
          <div className="flex items-center">
            <figure className="size-10 lg:size-16 relative">
              <Image src={"/logo/realMadrid.png"} alt="realMadrid" fill />
            </figure>
          ...
          <input
            min={0}
            max={10}
            className="bg-gray-300 w-10 text-center mx-2"
            type="number"
            placeholder="گل"
          />
        </div>
        ...
        <div className="flex items-center justify-center">
          ...
          />
          <div className="flex items-center">
            <h3 className="mx-2 text-base md:text-lg text-white">بارسلونا</h3>
            <figure className="size-10 lg:size-16 relative">
              <Image src={"/logo/barcelona.png"} alt="barcelona" fill />
            </figure>
          </div>
        </div>
      </div>
